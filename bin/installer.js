...
const fetchReleases = function (type, name, callback) {
  ...
  needle.get(`https://api.github.com${urlPath}`, {
    ...
    if (response.statusCode === 404) {
      return callback(new Error('*v3.0* Not found, see available connectors on https://deepstreamhub.com/open-source/ *v2.4 Not found, see available connectors on https://deepstream.io/download'))
    }
